...
import '../style/Footer.css'; // تأكد من استيراد ملف CSS

const Footer = () => {
  return(
    <footer className="px-4 bg-customPurple text-white font-montserrat pt-16 sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8 ml-0 mr-0 ">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2 mr-60">
          <a className="inline-block max-w-[160px]">
            <img src={image} alt="logo" className="max-w-full dark:hidden"/>
            <img src={image} alt="logo" className="max-w-full hidden dark:block"/>
          </a>
